...
const sections = [
  {
    ...
    subtitle: "",
    popupImage:
      "/assets/blog/focus/read-more-images/climate-change/WHO_060271-50039.jpg",
    content:
    ...
    popupContext: (
      <>
        <p>
          The rise in climate-related disease outbreaks in Africa highlights the
          urgent need to strengthen health systems through climate-resilient,
          sustainable, and low-carbon approaches. To address this, the JEAP
          incorporated a TWG focused on climate change into its action plan. The
          Climate Change TWG is setting a new standard for resilience in Africa
          by championing climate-resilient strategies for emergency preparedness
          and response, enhancing the region's capacity to prepare for, detect,
          and respond to climate-related health threats effectively.
        </p>
      </>
    ),
    popupVision:
    ...
    objectives: [
      {
        icon: "/assets/blog/focus/read-more-images/climate-change/icons/climate%20change.svg",
        text: "Support countries in developing and enhancing health systems that are resilient to the impacts of climate change, ensuring their ability to adapt and respond effectively to climate-related public health threats.",
      },
      {
        icon: "/assets/blog/focus/read-more-images/climate-change/icons/survilencwe.svg",
        text: "Facilitate the development of sustainable, low-carbon health systems that minimize environmental impact while maintaining efficiency and effectiveness.",
      },
      {
        icon: "/assets/blog/focus/read-more-images/climate-change/icons/multi%20sector%20coordination.svg",
        text: "Support countries and the region in establishing or strengthening multi-sectoral coordination mechanisms that integrate emergency response efforts at the intersection of climate change and health.",
      },
    ],
    progressText: [
      {
  ...
  },
  {
    ...
    popupImage:
      "/assets/blog/focus/read-more-images/country-assesment/country-assessment.jpg",
    content:
    ...
    popupContext: (
      <>
        <p>
          Since the launch of International Health Regulations (IHR, 2005),
          Member States across the African continent have invested in
          strengthening IHR preparedness capacities to enhance detection,
          prevention, and response to public health emergencies. Several
          assessments in line with IHR Monitoring and Evaluation (M&E) Framework
          and Performance of Veterinary Services (PVS) Pathway have been
          implemented to monitor and evaluate capacities’ development in
          preparedness in human health services, veterinary services and aquatic
          and animal health services. These instruments have assessed the status
          of preparedness and enabled documentation of progress countries have
          made in building their capacities.
        </p>
        <br />
        <p>
          Across the continent, there has been strong uptake of preparedness
          tools. In 2023, all African countries completed their required State
          Parties Annual Reporting (SPAR) assessment. From the beginning of 2023
          through May 2024, 4 countries completed inter-action reviews (IARs)12,
          1 conducted an after-action review (AAR),12 9 completed national
          planning workshops with another 8 in the pipeline for this year,13 and
          21 completed voluntary Joint External Evaluation (JEE) assessments,
          with another 13 scheduled this year.14 Additionally, of the 11
          countries with NAPHS publicly available on the WHO Strategic
          Partnership Portal, 7 are from Africa.15 Further, there have been
          several simulation exercises (SimEx) including cross-border SimEx to
          help develop, assess and test functional capabilities of emergency
          systems.
        </p>
      </>
    ),
    ...
    objectives: [
      {
        icon: "/assets/blog/focus/read-more-images/country-assesment/icons/Untitled-1-01.svg",
        text: "Ensure the harmonization of EPR tools and processes",
      },
      {
        icon: "/assets/blog/focus/read-more-images/country-assesment/icons/Untitled-1-02.svg",
        text: "Support countries to conduct and report on EPR capacity assessments",
      },
      {
        icon: "/assets/blog/focus/read-more-images/country-assesment/icons/Untitled-1-03.svg",
        text: "Support countries to develop and implement action plans",
      },
    ],
    progressText: [
      {
        textHeading:
          "Jointly supported simulation exercises, including cross-border exercises",
        textContent:
      ...
      {
        textHeading:
          "Increased information-sharing to harmonize regional support and improve efficiency",
        textContent:
  ...
  },
  {
    ...
    subtitle: "",
    popupImage:
      "/assets/blog/focus/read-more-images/digitization/CW5A5581_141830.jpg",
    content:
    ...
    popupContext: (
      <>
        <p>
          The aftermath of the COVID-19 pandemic highlighted the critical need
          for technology-driven solutions in Africa's health sector to
          strengthen countries' ability to promptly prepare for, detect, and
          respond to health emergencies. In response, the Digitalization TWG, a
          cross-cutting initiative within JEAP, was established to address this
          need and now leads the integration of digital solutions across other
          TWGs.
        </p>
      </>
    ),
    ...
    progressText: [
      {
        ...
        textContent: (
          <>
            The JEAP Digitalization TWG organized the following digitalization
            capacity building endeavours:
            <br />
            <ul className="list-none">
              <li>
                a. A retreat for primary healthcare (PHC) workers, focused on
                enhancing their digital capacities. The event brought together
                30 participants, fostering skill development and knowledge
                sharing.
              </li>
              <li>
                b. A major synergy event with 50 stakeholders to identify
                collaboration opportunities across digitalization projects at
                Africa CDC.
              </li>
              <li>
                c. JEAP actively participated in the Africa Health ExCon
                conference in Cairo.
              </li>
              <li>
                d.JEAP is implementing the Global Digital Health Certification
                Network (GDHCN) for yellow fever vaccination, replacing paper
                certificates. Seven of our countries have committed to adopting
                this digital certification.
              </li>
              <li>
                e. JEAP has partnered with Google Health to explore use cases
                for event-based surveillance, with plans to showcase solutions
                at the upcoming Africa Health Summit.
              </li>
            </ul>
          </>
        ),
      },
      {
        textHeading: "",
        textContent:
          "Building a digital workforce database for digitalization of the Workforce Development TWG by supporting  the development of its technical specifications.",
      },
      {
        textHeading: "",
        textContent:
          "Supporting the creation of a tool to optimize the prepositioning of health supplies in the Operations, Supply and, Logistics (OSL) TWG. ",
      },
      {
        textHeading: "",
        textContent:
          "JEAP participated in the World Summit for Information Society (WSYS+20) side event, promoting the Global Initiative for Digital Health.",
      },
      {
        textHeading: "",
        textContent:
  ...
  },
  {
    ...
    subtitle: "",
    popupImage:
      "/assets/blog/focus/read-more-images/operations,%20supply%20and%20logistics/20220425_Darfur_HCF_20%20(1).jpg",
    content:
    ...
    popupContext: (
      <>
        <p>
          Logistics is an essential part of emergency response – yet delays in
          the delivery of medical supplies and gaps in human resources for
          logistics remain major challenges across the continent.
        </p>
      </>
    ),
    popupVision:
    ...
    progressText: [
      {
        textHeading:
          "Pooled resources to reach countries with medical supplies",
        textContent:
  ...
  },
  {
    ...
    subtitle: "",
    popupImage:
      "/assets/blog/focus/read-more-images/rcce/WHO_GUINEA_EBOLA_9849-89427.jpg",
    content:
    ...
    popupContext: (
      <>
        <p>
          The JEAP recognizes the importance of Improved community preparedness,
          knowledge, and engagement in responding to health emergencies. JEAP is
          addressing the critical gaps in risk communication and community
          engagement (RCCE) highlighted during the Covid-19 pandemic by tackling
          major RCCE challenges such as weak strategies, poor implementation,
          and fragmented efforts across countries. By enhancing coordination and
          promoting integrated, results-driven RCCE strategies, JEAP is ensuring
          that RCCE and information management (IM) are prioritized in health
          emergencies.{" "}
        </p>
      </>
    ),
    ...
    progressText: [
      {
        textHeading: "",
        textContent:
          "JEAP is driving the development of a regional RCCE strategy to standardize practices across the region for enhanced response during public health emergencies.",
      },
      {
        textHeading: "",
        textContent:
          "Supporting countries in creating national RCCE plans and standard operating procedures (SOPs) by conducting assessments to map core RCCE capacities.",
      },
      {
        textHeading: "",
        textContent:
          "Facilitating the institutionalization of existing mechanisms and platforms to enhance community engagement and resilience.",
      },
      {
        textHeading: "",
        textContent:
          "Focusing on establishing social listening tools and infodemic management systems for real-time analysis and informed decision-making.",
      },
      {
        textHeading: "",
        textContent:
          "Strengthening human resources and mobilizing resources within RCCE and infodemic management to ensure sustained effectiveness.",
      },
    ],
  },
  {
    ...
    subtitle: "",
    popupImage:
      "/assets/blog/focus/read-more-images/response-rediness/WHO_Ebola%20DR%20Congo%2017JUN2019_0384-2.jpg",
    content:
    ...
    popupContext: (
      <>
        <p>
          While most African countries have now established a Public Health
          Emergency Operations Centre (PHEOC), recent evaluations highlight that
          implementation capabilities vary.6 A PHEOC is a hub for joint risk
          assessment, planning, and coordination of information and resources
          for effective emergency management. Many countries established and
          operationalized PHEOCs in the aftermath of Ebola Virus Disease (EVD)
          epidemic in West Africa, supporting stronger emergency coordination.
        </p>
      </>
    ),
    popupVision:
    ...
    progressText: [
      ...
      {
        textHeading:
          "Engaged Member States to adapt and operationalize plan through Ministerial Meetings and rapid assessments",
        textContent:
      ...
      {
        textHeading:
          "Continued joint management of a regional PHEOC network to encourage best practices and knowledge-sharing",
        textContent:
  ...
  },
  {
    ...
    subtitle: "",
    popupImage:
      "/assets/blog/focus/read-more-images/surveillance/Surveillance.png",
    content:
    ...
    popupContext: (
      <>
        <p>
          Surveillance systems and technologies across the continent are
          lacking, with some countries not meeting the Integrated Diseases
          Surveillance & Response (IDSR) standards, leading to delays in
          detecting health emergencies. Despite scientific development to
          strengthen the health system to protect human health, Africa continues
          to be confronted by longstanding, emerging, and reemerging infectious
          disease threats. Unfortunately, the region has a relatively low
          capacity for risk management of disease epidemics, mainly due to
          inadequate resources for early detection, identification, and prompt
          response. The failure in the early detection and response to epidemics
          in Africa is attributed to several factors, including deficiency in
          the development and implementation of surveillance and response
          systems against infectious disease outbreaks.
        </p>
      </>
    ),
    popupVision:
    ...
    objectives: [
      {
        icon: "/assets/blog/focus/read-more-images/surveillance/icons/Untitled-1-01.svg",
        text: "Ensure all member states have capacity to timely detect and respond to public health threats",
      },
      {
        icon: "/assets/blog/focus/read-more-images/surveillance/icons/Untitled-1-02.svg",
        text: "Ensure all member states have laboratory capacity to diagnose and report pathogens that can cause outbreaks",
      },
      {
        icon: "/assets/blog/focus/read-more-images/surveillance/icons/Untitled-1-03.svg",
        text: "Establish a functional continental framework for data and information exchange",
      },
      {
        icon: "/assets/blog/focus/read-more-images/surveillance/icons/Untitled-1-04.svg",
        text: "Ensure all member states have laboratory sequencing capacity for pathogens that can cause outbreaks",
      },
    ],
    progressText: [
      {
      ...
      {
        textHeading:
          "Advanced the harmonization of cross-border collection, handling and shipment of all pathogens",
        textContent:
  ...
  },
  {
    ...
    subtitle: "",
    popupImage:
      "/assets/blog/focus/read-more-images/workforce-deployment/Miaron_0025-149336.jpg",
    content:
    ...
    popupContext: (
      <>
        <p>
          Human resources are the heart of emergency response, but there
          continues to be a shortage of trained, equipped emergency responders
          on the African continent. According to WHO analysis, fewer than 10% of
          African countries are adequately staffed to prepare for and respond to
          health emergencies.
        </p>
      </>
    ),
    ...
    objectives: [
      {
        icon: "/assets/blog/focus/read-more-images/workforce-deployment/icons/Untitled-1-01.svg",
        text: "Support the identification, capacity building and retainment of emergency health workforce",
      },
      {
        icon: "/assets/blog/focus/read-more-images/workforce-deployment/icons/Untitled-1-02.svg",
        text: "Ensure the coordination and deployment of emergency health workforce",
      },
      {
        icon: "/assets/blog/focus/read-more-images/workforce-deployment/icons/Untitled-1-03.svg",
        text: "Reinforce the emergency health workforce leadership",
      },
    ],
    progressText: [
      {
        textHeading:
          "Enrolled and trained 1350 AVoHC-SURGE across 16 countries",
        textContent: (
          <>
            In each of these countries, a similar process was followed, tailored
            to the specific country needs:
            <br />
            <ul className="list-none">
              <li>
                a. Scoping missions: Scoping missions were conducted to engage
                with the government and in-country partners on the country’s
                readiness to manage health crises effectively, resulting in
                roadmaps aligned with the existing National Action Plan for
                Health Security (NAPHS).
              </li>
              <li>
                b. Government-led, multi-sectoral selection process: In each
                country, the Ministry of Health led the establishment of a
                multisectoral selection committee comprising representatives
                from relevant sectors. This committee was tasked with managing
                the selection of the multisectoral and multidisciplinary
                response team members for onboarding and specialized training.
                The selected trainees come from a range of disciplines and areas
                of expertise, such as epidemiology, laboratory science,
                anthropology, entomology, veterinary medicine, data management,
                field logistics and operation, infection prevention and control,
                RCCE and Gender-Based Violence (GBV). Overall, 31% are female.
                Namibia enrolled more females than males (65% females) and
                Nigeria and Botswana also had greater than 40% females. Of the
                trained responders, 75% are from Ministries of Health while 25%
                are from sectors other than health, representing a strong
                commitment to One Health).
              </li>
              <li>
                Training: WHO/AFRO in collaboration with WHO country offices,
                the government and in-country partners trained the selected
                AVoHC-SURGE responders. This included a standardized curriculum
                of in-person modules over nine days to cover key topics in
                emergency response, preceded by online, pre-work. The countries
                with the highest number of responders trained were the
                Democratic Republic of the Congo (DRC) (214), followed by the
                United Republic of Tanzania (193), Ethiopia (190) and Kenya
                (118).
              </li>
            </ul>
          </>
      ...
      {
        textHeading:
          "Supported activation of AVoHC-SURGE members in 14 Member States to tackle various emergencies",
        textContent:
      ...
      {
        textHeading:
          "Began developing an interoperable workforce platform for comprehensive management and deployment",
        textContent:
      ...
      {
        textHeading:
          "Conceptualized a regional emergency preparedness and response leaders network",
        textContent:
    ...
    <div className="text-white p-4 md:w-[90%] my-0 mx-auto">
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="w-full lg:w-1/4">
              ...
              <div key={section.title} className="border-b-2 border-white mb-2">
                ...
                {selected.title === section.title && (
                  <div className="py-3 px-1">
                    ...
                    <button
                      className="bg-white text-blue-900 px-6 py-2 font-semibold flex items-center gap-2 hover:bg-gray-200"
          ...
          <div className="hidden lg:block">
            {sections.map((section) => (
              <div
                key={section.id}
                className="relative hover:bg-[#2c5377] group"
              >
                <button
                  key={section.title}
                  className={`w-full text-left px-3 py-5 block ${
                    selected.title === section.title ? "bg-[#4c7fae]" : ""
                  } ${section.id !== sections.length ? " border-b " : ""}`}
                  onClick={() => setSelected(section)}
                >
                  {section.title}
                </button>
        ...
        <div className="hidden md:block w-full lg:w-3/4 bg-[rgb(37_73_119)] p-8 relative">
          ...
          <p className="my-4 text-gray-300 border-t-2 pt-4 line-clamp-[8] text-lg xl:text-xl xl:leading-8">
            {selected.content}
          </p>
          <button
            className="md:h-[45px] absolute -bottom-4 right-8 bg-white text-blue-900 px-6 py-2 font-semibold flex items-center gap-2 hover:bg-gray-200"
            onClick={() => handleReadMoreClick()}
          >
            Read More →
          </button>
      ...
      {modalOpen && selected.id === currentIndex && (
        <div className="fixed inset-0 bg-[#fff] items-center justify-center z-50 h-screen overflow-scroll">
          <div className="sticky top-5 z-20 h-auto w-full flex justify-end items-end mt-4">
            <button
              onClick={closeModal}
              className="z-40 w-auto h-auto sticky top-4 right-8 bg-green-900 text-white hover:text-gray-300"
            >
              <svg
                className="w-9 h-9"
                fill="none"
            ...
            <div className="pt-3">
              ...
              <div className="relative bg-gradient-to-b from-[rgb(1_33_91)] via-[rgb(8_48_80)] to-[#1B5632]">
                <div className="text-white flex flex-col items-left justify-left p-10 lg:py-10 lg:px-40">
                  ...
                  <div className="text-3xl font-bold  my-2 xl:my-4">
                    {selected.subtitle}
                  </div>
                  <div className="text-3xl my-2">Context</div>
                  <div className="border-t-2 my-4 py-4 xl:py-8 text-base xl:text-lg">
              ...
              <div className="w-full bg-[#1B56321A] py-2">
                <div className="flex w-full px-10 lg:px-40 mx-auto ">
                  ...
                  <div className="w-full content text-left my-4">
                    ...
                    <p className="text-black text-x pt-4 border-t-2 border-black">
                      {selected.popupVision}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {selected.objectives.length ? (
                <div className="flex flex-col items-center">
                  <h2 className="text-black text-3xl font-bold my-4">
                    Objectives
                  </h2>
                        ...
                        return (
                          <div
                            ...
                            className={`border-white rounded-s-[2rem] rounded-e-[2rem] py-4 px-4 xl:py-15 xl:px-15 2xl:py-10 2xl:px-15 flex flex-col gap-4 ${
                              selected.progressText.length - 1 !== i
                                ? "border"
                                : "border border-t-0"
                            }`}
                          >
                            {text?.textHeading ? (
                              <h3 className="text-2xl lg:pl-8">
                                {text?.textHeading}
                              </h3>
                            ) : null}
                            <div className="text-base xl:text-lg lg:pl-8">
                              {text.textContent}
                            </div>
                          </div>
                        );
