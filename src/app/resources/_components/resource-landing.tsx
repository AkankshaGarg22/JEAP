...
export default function ResourceLanding() {
  ...
  return (
    <div className="min-h-screen fixed w-full" ref={parallaxRef}>
      <section className="relative text-white w-full h-screen 2xl:w-dvw bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center [clip-path:circle(75%_at_49%_29%)] md:[clip-path:circle(180vh_at_50%_-80vh)] bg-resource-landing">
