...
const slides = [
  { id: 1, reportSrc: "/assets/blog/resources/Jeap Report.jpg", href: "/assets/blog/resources/Revised JEAP Report (Nov 7) .pdf" },
  { id: 2, reportSrc: "/assets/blog/Resources_plan.png", href: "/assets/blog/Joint EPR Detailed Action Plan Final Report.pdf" },
  { id: 3, reportSrc: "/assets/blog/Joint EPR Digital Brochure.jpg", href: "/assets/blog/Final Digital Brochure File.pdf" },
  { id: 4, reportSrc: "/assets/blog/Joint EPR Final Case Study.jpg", href: "/assets/blog/Final Case Study File Draft 6.pdf" },
];
    ...
    <div className="h-screen xl:h-screen flex flex-col items-center justify-start md:justify-center xl:justify-center bg-cover xl:bg-cover bg-no-repeat bg-mb-partner-curve bg-top md:bg-xl-about-curve z-[200]">
      ...
      {/* <div className="flex flex-col sm:space-y-[60px] lg:space-y-0 md:space-y-0 lg:space-x-[100px] lg:flex-row justify-evenly items-center md:p-4 p-2 gap-[2rem]">
        <div className="shadow-[12px_12px_37px] shadow-[#0000001C] bg-[hsla(0,0%,100%,.1)] backdrop-blur-2xl md:p-[60px] p-[30px]">
          <a className="flex justify-center items-center" href="/assets/blog/resources/Revised JEAP Report (Nov 7) .pdf" download="JEAP Report.pdf" target='_blank'>
            <div className="hidden md:flex justify-center items-center relative h-[400px] w-[300px] mx-auto ">
      ...
      <div className="relative flex items-center justify-center w-full">
        ...
        <div className="hidden md:flex gap-16 items-center">
          {/* Main Active Image */}
          <a className="bg-[#3a6e63] p-8 flex justify-center items-center" href={slides[current].reportSrc} download="JEAP Report.pdf" target="_blank">
            <div className="relative h-[400px] w-[300px]">
              <img src={slides[current].reportSrc} alt="Active Slide" className="h-full w-full object-cover rounded-lg" />
              {/* Hover Overlay */}
              <div className="absolute inset-0 bg-black bg-opacity-60 opacity-0 transition-opacity duration-500 hover:opacity-100 flex justify-center items-center">
                <div className="text-center">
                  <img src="/assets/blog/Path 14204 2.svg" alt="Download Icon" className="h-12 w-12 mx-auto" />
          ...
          {/* Small Next Image */}
          <div className="bg-[#3a6e63] p-4">
            <div className="h-[250px] w-[180px] opacity-75 transition-opacity duration-500">
              <img src={slides[(current + 1) % slides.length].reportSrc} alt="Next Slide" className="h-full w-full object-cover rounded-lg" />
            </div>
          </div>
        </div>

        {/* Mobile View - Only One Image */}
        <a className="md:hidden relative w-[300px] h-[400px]" href={slides[current].reportSrc} download="JEAP Report.pdf" target="_blank">
          <img src={slides[current].reportSrc} alt="Mobile Slide" className="h-full w-full object-cover rounded-lg" />
          {/* Hover Overlay */}
          <div className="absolute inset-0 bg-black bg-opacity-60 opacity-0 transition-opacity duration-500 hover:opacity-100 flex justify-center items-center">
            <div className="text-center">
              <img src="/assets/blog/Path 14204 2.svg" alt="Download Icon" className="h-12 w-12 mx-auto" />
        ...
        {/* Navigation Buttons */}
        <button onClick={handlePrev} className="absolute left-0 md:left-[60%] top-1/2 md:top-0 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 border">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
        </button>
        <button onClick={handleNext} className="absolute right-0 md:right-[33%] top-1/2 md:top-0 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 border">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
