  ...
  return (
    <section className="bg-white md:py-10 py-4">
      <div className="md:p-10 relative bg-gradient-to-b to-[#1b5632] via-[#195334] from-[#01205d] text-white pb-8 pt-8">
        <div className="max-w-7xl mx-auto flex flex-col justify-evenly lg:grid lg:grid-cols-12 pb-4 px-6 md:px-0 gap-6">
          ...
          <Paragraph className="col-span-8 mt-4 md:mt-0 order-2 block items-center">
        ...
        <div className="max-w-7xl px-6 md:px-0 mx-auto my-auto lg:grid grid-cols-1 lg:grid-cols-12">
