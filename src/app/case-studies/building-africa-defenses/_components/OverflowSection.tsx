...
const OverflowSection = () => {
  return (
    <>  
        <div className="w-full h-auto flex flex-col items-center justify-center py-12 bg-gradient-to-b from-[#1E2859] to-[#1D5539]"> 
            {/* JOINING FORCES TO ENSURE EVERY AFRICAN COUNTRY HAS GENOMIC SEQUENCING CAPABILITY */}
            <div className="lg:max-w-7xl mx-auto bg-transparent flex flex-col lg:flex-row items-start justify-center gap-24 lg:pb-8">
            ...
            {/* Member States */}
            <div className="lg:max-w-7xl mx-auto flex items-center justify-center lg:pb-8">
        ...
        <div className="lg:max-w-7xl mx-auto h-auto flex flex-col lg:flex-row items-start justify-center gap-16">
