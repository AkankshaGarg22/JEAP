...
const OverflowSection = () => {
  return (
    <>  
        <div className="w-full h-auto flex flex-col gap-8 items-center justify-center py-10 bg-gradient-to-b from-[#1E2859] to-[#1D5539]"> 
            {/* JOINING FORCES TO ENSURE EVERY AFRICAN COUNTRY HAS GENOMIC SEQUENCING CAPABILITY */}
            <div className="w-[80%] bg-transparent flex flex-col lg:flex-row items-center justify-center gap-24">
                ...
                <div className="w-[60%] h-auto flex items-center justify-center">
                  <img src="/assets/blog/case-studies/Building_Africa_Defenses/webp/WHO_25.05.23_72dpi©CecileRolland-103.jpg" className="w-full h-[600px]"/>
                </div>
            </div>
            {/* Member States */}
        ...
        <div className="bg-white w-full h-auto flex flex-col items-center justify-center py-10 ">
        <div className="w-[80%] h-auto flex flex-col lg:flex-row items-center justify-center gap-12">
                  <AnimatedHeading linecolor="black" className="text-black">THE JEAP’S INVESTMENTS IN CONNECTED LABORATORY NETWORKS ON THE CONTINENT</AnimatedHeading>
                 <div className="w-full flex items-center justify-center flex-col gap-6" >
                  <Paragraph className="text-black">In 2020, Africa CDC in collaboration with WHO and jointly with public, philanthropic, and private sector partners launched a continent-wide Pathogen Genomics Initiative (Africa PGI) with a short-term focus on accelerating SARS-CoV-2 sequencing, and a long-term vision of strengthening systems to support the monitoring of other priority pathogens in Africa.15  </Paragraph><Paragraph className="text-black"> Since its launch, the PGI has substantially increased genomics sequencing capacity in Africa and expanded access to this technology across the continent from 7 countries in 2019 to 40 in 2023. The PGI also democratized the technology by distributing one of the continent’s largest-ever sequencing equipment, including ancillary equipment and automated systems. The partnership has also supported i) the diagnosis and sequencing of SARS-COV-2 with over 140,000 SARS-CoV-2 genomes sequenced16, Marburg Virus, Ebola virus, Mpox, Dengue, and Cholera cases; ii) the continental genomic surveillance and sample referral system; iii) expanded data storage and analytics capacity, and iv) trained more than 950 experts in sample management, genomics, bioinformatics, data interpretation and reporting. These capacities are currently being leveraged for Mpox sequencing in the Democratic Republic of Congo (DRC), the Congo and Cameroon.</Paragraph>
                </div>
                </div>
        </div>
