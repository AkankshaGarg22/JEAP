...
const OverflowSection = () => {
  return (
    <>  
        <div className="w-full h-auto flex flex-col items-center justify-center md:py-12 py-4 bg-gradient-to-b from-[#1E2859] to-[#1D5539]"> 
            {/* JOINING FORCES TO ENSURE EVERY AFRICAN COUNTRY HAS GENOMIC SEQUENCING CAPABILITY */}
            <div className="lg:max-w-7xl mx-auto w-[90%] bg-transparent flex flex-col lg:flex-row items-start justify-center md:gap-24 gap-4 lg:pb-8">
                <div className="md:w-[40%] h-auto flex flex-col items-center justify-center md:gap-12 gap-4">
        ...
        <div className="bg-white w-full h-auto flex flex-col items-center justify-center md:py-12 py-4">
        <div className="lg:max-w-7xl lg:w-[90%] mx-auto h-auto flex flex-col lg:flex-row items-start justify-center md:gap-16 gap-4">
                  <AnimatedHeading linecolor="black" className="text-black w-auto">The JEAP’s Investments in Connected Laborotary Networks on the Continent</AnimatedHeading>
