...
const TextSectionTwo = () => {
  return (
    ...
    <div className="w-full flex flex-col items-center gap-6 justify-center h-auto bg-white py-10">
      <div className="lg:w-[80%] flex flex-col lg:flex-row h-auto bg-white items-center justify-center">
        <div className="bg-transparent w-[25%]">
          <img
            src="/assets/blog/case-studies/Building_Africa_Defenses/webp/Rectangle 2882.webp"
            className="h-[325px] w-[100%]"
          ></img>
        </div>

        <div className="bg-gradient-to-t from-[#1E2859] to-[#1D5539] w-[70%] p-4 py-8">
      ...
      <div className="w-[80%] flex h-auto bg-white items-center justify-center">
