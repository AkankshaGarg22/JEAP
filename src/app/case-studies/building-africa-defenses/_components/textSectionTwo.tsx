...
const TextSectionTwo = () => {
  return (
    ...
    <div className="w-full flex flex-col items-center gap-6 justify-center h-auto bg-white py-12">
      ...
      <div className="lg:w-[80%] flex flex-col lg:flex-row h-auto bg-white items-center justify-center">
        <div className="bg-transparent w-[35%] h-[450px]">
          <img
        ...
        <div className="bg-gradient-to-t from-[#1E2859] to-[#1D5539] w-[65%] px-12 py-12">
