...
const TextSectionThree = () => {
  return (
<>
<div className="bg-gradient-to-b from-[#1E2859] to-[#1D5539] w-full h-auto flex flex-col items-center justify-center py-12">
    <div className="w-[80%] h-auto bg-transparent flex lg:flex-row flex-col gap-6 items-start justify-center">
        ...
        <div className="w-[65%] h-auto flex flex-col gap-4 items-center justify-center">
    ...
    <div className="w-[80%] h-[750px] bg-transparent flex items-center justify-center py-12">
    ...
    <div className="w-[80%] h-auto bg-transparent flex items-center justify-center">
