  ...
  return (
    <>
       ...
       <div className="w-full h-auto flex items-center justify-center py-10"> 
        <div className="w-[80%] h-auto bg-white flex flex-col items-center justify-center gap-6">
...
{/* LOOKING AHEAD: EXPANDING THE LABORATORY NETWORK AND PILOTING USE CASES FOR GENOMIC AND EPIDEMIOLOGICAL EVIDENCE IN PUBLIC HEALTH DECISION-MAKING */}
       <div className="w-full h-auto flex flex-col gap-12 items-center justify-center py-16 bg-gradient-to-t from-[#1E2859] to-[#1D5539]">
            <div className="w-[80%] flex flex-col gap-8 lg:flex-row items-center justify-center">
            ...
            <div className="w-[80%] h-auto flex flex-col items-center justify-center gap-6">
                <img src="/assets/blog/case-studies/Building_Africa_Defenses/webp/JKG_0276.webp" className="w-[100%] h-[500px]"></img>
