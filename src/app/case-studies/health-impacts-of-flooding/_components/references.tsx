    ...
    <section className="max-w-7xl mx-auto px-4 mb-12">
      ...
      <div className="w-full flex flex-col gap-4 justify-between">
        ...
        <p className="text-sm">
          ...
          health emergencies.
          <a target="_blank" href="https://www.afro.who.int/news/africa-faces-rising-climate-linked-health-emergencies">https://www.afro.who.int/news/africa-faces-rising-climate-linked-health-emergencies</a>
          <br />
