    ...
    <section className="min-h-screen bg-white">
      ...
      <div className="relative">
        <div className="w-full h-[60vh] md:h-[50vh] lg:h-[80vh] relative">
          <Image className="object-top" src="/assets/blog/case-studies/Gender_equality/Webp_format/1.webp" alt="JEAP Partnership Members" layout="fill" objectFit="cover" priority />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#1b5632]"></div>

          {/* Hero Text */}
          <div className="absolute bottom-10 w-full">
            <div className="max-w-6xl mx-auto px-6 md:px-12">
              <h1 className="text-3xl md:text-4xl md:leading-[48px] font-extrabold mb-4 text-white">GENDER EQUALITY IN EMERGENCY PREPAREDNESS AND RESPONSE: A FOCUS ON THE AVOHC-SURGE INITIATIVE</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className=" md:py-10  bg-gradient-to-b from-[#1b5632] via-[#195334] to-[#01205d] text-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 px-6 md:px-12 py-8 md:py-10">
          ...
          <div className="lg:col-span-12 order-1 mb-6">
            <h2 className="text-xl md:text-2xl md:leading-[40px] font-semibold mb-4">
          ...
          <div className="lg:col-span-12 order-2">
            ...
            <Paragraph className="mt-1">
              ...
              health worker jobs.3 The number drops dramatically to 5%4 for women from low -middle income countries in leadership.
            </Paragraph>
          </div>
          ...
          <div className="relative w-full bg-[#386d64] text-white py-8 px-4 before:content-[''] before:absolute before:top-0 before:left-1/4 before:-translate-x-1/2 before:-translate-y-1/2 before:border-l-[50px] before:border-r-[50px] before:border-b-[24px] before:border-l-transparent before:border-r-transparent before:border-[#386d64]">
            <div className="container mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold">Women make up 70% of health workers, yet occupy just 23% of leadership roles in the sector.</h2>
            </div>
          </div>
            </div>      
