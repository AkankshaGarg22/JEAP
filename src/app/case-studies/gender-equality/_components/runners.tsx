...
export default function Runners() {
  return (
    <section className="relative w-full bg-gradient-to-br from-[#00205C] to-[#1A5632] py-4 md:py-16 px-6 md:px-12 lg:px-16 my-4 md:my-12 lg:my-24 overflow-visible">
      {/* Content Container */}
