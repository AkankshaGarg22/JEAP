      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="flex flex-col lg:flex-row lg:items-center">
          ...
          <div className="lg:w-3/5 z-10">
            <AnimatedHeading linecolor="white" fontSize="1.5rem" className="w-1/2 text-white">
              LESOTHO AND NAMIBIA ARE FRONTRUNNERS IN RECRUITING AND DEPLOYING WOMEN TO THEIR HEALTH EMERGENCY RESPONDER TEAMS
            </AnimatedHeading>

            <p className="text-gray-100 text-base md:text-lg my-8 md:my-12">
        ...
        <div className="bg-[#386d64] my-4 p-4 md:p-8 text-white w-full">
          <Paragraph>
            For instance, Namibia has the <span className="font-bold">8th highest gender-parity</span> ranking in the world, and is the only country in Sub-Saharan African making the top 10 list. The
            ...
            and participation: <span className="font-bold"> With 56% of technical workers and 43.6% of senior officers being women</span>, resulting in Namibia ranking 19th globally in terms of women
            in the workforce.
          </Paragraph>
        </div>
      </div>
