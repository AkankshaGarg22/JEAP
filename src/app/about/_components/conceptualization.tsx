...
export default function Conceptualization() {
  ...
  return (
    <div className="xl:h-screen bg-gradient-to-b from-[#1b5632] via-[#195334] to-[#01205d] text-white flex flex-col gap-4 3xl:gap-8 items-center xl:justify-around py-2">
      ...
      <p className="w-4/5 xl:w-9/10 text-base xl:text-[18px] 3xl:text-2xl">
      ...
      <div className="hidden md:flex items-start gap-8 w-4/5">
        ...
        <div className="flex-1 h-[50vh] 3xl:h-[35vh] overflow-y-scroll no-scrollbar" ref={containerRef}>
          <div className="relative xl:h-[180vh] 2xl:[h-90vh] 3xl:h-[80vh] 4xl:h-[75vh]">
