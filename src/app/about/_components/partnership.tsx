...
export default function PartnerShip() {
  ...
  return (
    <div className="h-screen xl:h-screen flex flex-col items-center justify-start md:justify-center xl:justify-center bg-cover xl:bg-cover bg-no-repeat bg-mb-about-curve bg-top md:bg-xl-about-curve z-[200]">
      <div className="basis-1/5 md:basis-1/4 2xl:basis-1/3 flex flex-col items-center justify-end md:justify-center xl:justify-end mb-4 md:mt-8 gap-2 xl:gap-2 text-center text-white md:w-3/4 md:pt-8 ">
      ...
      <div className="basis-4/5 md:basis-3/4 2xl:basis-2/3 w-full xl:w-5/6 relative mb-2 xl:mb-0">
              ...
              <div key={slide.id} className="w-full flex-shrink-0 flex flex-col gap-2 md:gap-0 xl:gap-8 md:justify-around">
                ...
                <div className="md:basis-9/10 xl:basis-4/5 flex flex-col xl:flex-row items-center xl:items-stretch justify-center gap-2 md:gap-6 xl:gap-2 px-4">
                  {slide.items.map((item, idx) => (
                    ...
                    >
                      <img className="h-40 xl:h-60 2xl:h-[30rem] w-full rounded-t-3xl object-cover p-1 md:p-2" src={item.img} alt={item.header} />
                      <p className="text-center text-base xl:text-lg 2xl:text-xl py-2 px-2">{item.header}</p>
                    </div>
                  ))}
                </div>
              </div>
