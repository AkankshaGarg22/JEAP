    ...
    <div className="h-screen xl:h-screen flex flex-col items-center justify-start md:justify-center xl:justify-center bg-cover xl:bg-cover bg-no-repeat bg-mb-partner-curve bg-top md:bg-xl-about-curve z-[200]">
              ...
              <div key={slide.id} className="w-full flex-shrink-0 flex flex-col gap-2 md:gap-0 xl:gap-8 md:justify-around">
                ...
                <button onClick={handlePrev} className="flex items-end transform -translate-y-1/2 z-10" aria-label="Previous slide">
                  ...
                  {slide.items.map((item, idx) => (
                    <div
                      key={idx}
                      className="border border-white flex flex-col rounded-3xl w-4/5 md:w-[35%] text-white cursor-pointer transition-colors duration-300 hover:bg-white hover:text-green-800"
      ...
      {modalOpen && selectedItem && (
        <div className="fixed inset-0 bg-[#185136] xl:bg-gradient-to-b from-[#1b5632] via-[#195334] to-[#01205d]  xl:bg-opacity-50 flex items-center justify-center z-50">
          ...
          <div className="bg-[#185136] xl:bg-[#46735f] xl:bg-opacity-50 text-white rounded-xl w-4/5 md:w-3/4 lg:w-2/3 xl:w-2/3 p-4 relative overflow-hidden">
            {/* Close button */}
