    ...
    <div className="relative w-full flex justify-center">
      <div className="header-bar w-[95%] md:w-[90%] xl:w-[60%] flex flex-row items-center justify-between md:p-[12px] z-[90] rounded-[50px] mt-5 absolute">
        ...
        <div className="hidden md:flex header-links flex-row items-center gap-4 md:gap-1 md:py-3">
          <Link href="/about">
            <h2 className=" md:text-[12px] xl:text-[14px] font-semibold">ABOUT THE JEAP</h2>
          </Link>

          <Link href="/focus">
            <h2 className="font-semibold md:text-[12px] xl:text-[14px] ">FOCUS AREAS</h2>
          </Link>

          <Link href="#">
            <h2 className="font-semibold md:text-[12px] xl:text-[14px] ">CONNECT WITH US</h2>
          </Link>

          <Link href="#">
            <h2 className=" md:text-[12px] xl:text-[14px] font-semibold">IMPACT</h2>
          </Link>

          <Link href="#">
            <h2 className=" md:text-[12px] xl:text-[14px] font-semibold">RESOURCES</h2>
          </Link>
        </div>
