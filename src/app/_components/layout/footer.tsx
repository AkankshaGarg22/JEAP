...
export function Footer() {
  ...
  <div className="w-full max-w-6xl flex flex-col items-center justify-between h-full py-2">
    ...
    <div className="flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-4 items-center justify-center text-center font-ArialRegular lg:p-0 pt-4">
      <span><a href="about" className="text-sm md:text-lg text-white ">About the JEAP</a></span>
      <span><a href="focus" className="text-sm md:text-lg text-white ">Focus Areas</a></span>
      <span><a href="#" className="text-sm md:text-lg text-white ">Connect With Us</a></span>
      <span><a href="#" className="text-sm md:text-lg text-white ">Impact</a></span>
      <span className="col-span-2 md:col-span-1"><a href="#" className="text-sm md:text-lg text-white ">Resources</a></span>
    </div>
