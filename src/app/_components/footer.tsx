        ...
        <Container>
          <div className="flex flex-col p-4 lg:gap-20 lg:flex-row justify-center">
            <div className="footer-links text-white text-center">
              <p className="link-hover link-hover-footer p-0" onClick={() => scrollIntoView('mission')}>THE JEAP MISSION</p>
              <p className="link-hover link-hover-footer p-0" onClick={() => scrollIntoView('vision')}> THE JEAP VISION</p>
              <p className="link-hover link-hover-footer p-0" onClick={() => scrollIntoView('operation')}> OPERATIONALIZING THE JEAP</p>
