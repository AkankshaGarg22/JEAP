...
export function TurnAroundTime() {
    ...
    return (
        <div ref={ref}>
            <div className="min-h-screen h-full flex flex-col lg:flex-row items-center justify-center relative">
                                    ...
                                    >
                                        {
                                            <div className="h-[20px] w-[20px] md:h-[50px] md:w-[50px] bg-[#E8F8FC] rounded-full">
                                                <svg className="h-[15px] w-[15px] md:h-[25px] md:w-[25px] absolute left-[38%] top-[35%]" id="Group_3326" data-name="Group 3326" xmlns="http://www.w3.org/2000/svg" width="66.621" height="63.887" viewBox="0 0 66.621 63.887">
