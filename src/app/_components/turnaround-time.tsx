            ...
            <div className="absolute w-[100px] h-[100px] md:w-[220px] md:h-[220px] bg-white z-20 rounded-full">
                <div ref={ref} className="relative">
                    <CircularProgressbarWithChildren value={isVisible && innerProgress === 100 ? outerProgress : 0} styles={buildStyles({
                        ...
                        <div className="absolute w-[50px] h-[50px] md:w-[150px] md:h-[150px]">
                            ...
                            >
                                {
                                    <div className="h-[20px] w-[20px] md:h-[80px] md:w-[80px] bg-[#E8F8FC] rounded-full">
                                        <svg className="h-[18px] w-[18px] md:h-[35px] md:w-[35px] absolute left-[38%] top-[35%]" id="Group_3326" data-name="Group 3326" xmlns="http://www.w3.org/2000/svg" width="66.621" height="63.887" viewBox="0 0 66.621 63.887">
