...
export function TurnAroundTime() {
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center relative">
            ...
            <div className="z-10">
                <img className="z-10 h-[400px] md:h-[1000px]" src={"/assets/blog/24 to 48[1]-03.svg"} alt="image"></img>
            </div>
            <div className="absolute z-10">
                <img className="z-10 h-[400px] md:h-[1000px]" src={"/assets/blog/24 to 48[1]-02.svg"} alt="image"></img>
            </div>
            <div className="absolute z-10">
                <img className="z-10 h-[400px] md:h-[1000px]" src={"/assets/blog/24 to 48[1]-01.svg"} alt="image"></img>
            </div>

            <div className="absolute w-[100px] h-[100px] md:w-[300px] md:h-[300px] bg-white z-20 rounded-full">
                <div ref={ref} className="relative">
                    <CircularProgressbarWithChildren value={isVisible && innerProgress === 100 ? outerProgress : 0} styles={buildStyles({
                        ...
                        <div className="absolute w-[50px] h-[50px] md:w-[200px] md:h-[200px]">
                            ...
                            >
                                {
                                    <div className="h-[20px] w-[20px] md:h-[90px] md:w-[90px] bg-[#E8F8FC] rounded-full">
                                        <svg className="h-[18px] w-[18px] md:h-[55px] md:w-[55px] absolute left-[35%] top-[35%]" id="Group_3326" data-name="Group 3326" xmlns="http://www.w3.org/2000/svg" width="66.621" height="63.887" viewBox="0 0 66.621 63.887">
