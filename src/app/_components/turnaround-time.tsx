...
export function TurnAroundTime() {
    ...
    }, [innerProgress]); // Re-run effect when progress changes
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            if (innerProgress >= 100 && shouldFill && outerProgress < 100) {
                                    ...
                                    <VisibilitySensor>
                                        {(isVisible: any) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    {
                                                        <div className="h-[90px] w-[90px] bg-[#E8F8FC] rounded-full">
                                                            <svg className="h-[55px] w=[55px] absolute left-[35%] top-[35%]" id="Group_3326" data-name="Group 3326" xmlns="http://www.w3.org/2000/svg" width="66.621" height="63.887" viewBox="0 0 66.621 63.887">
                                                                ...
                                                                <path fill={shouldFill ? '#009BDD' : 'none'} id="Path_11309" data-name="Path 11309" d="M-200.5,278.47c-.206.109-.218.423-.218,3.893a18.53,18.53,0,0,0,.145,3.929,49.513,49.513,0,0,0,7.81,0,18.577,18.577,0,0,0,.144-3.929c0-3.615-.012-3.784-.229-3.9A57.753,57.753,0,0,0-200.5,278.47Z" transform="translate(223.393 -253.83)" stroke="#00205c" stroke-width="1" />
                                                                <path fill={shouldOuterFill ? '#009BDD' : 'none'} id="Path_11310" data-name="Path 11310" d="M-185.951,278.47c-.206.109-.218.423-.218,3.893a18.529,18.529,0,0,0,.145,3.929,49.508,49.508,0,0,0,7.81,0,18.53,18.53,0,0,0,.145-3.929c0-3.615-.013-3.784-.23-3.9A57.761,57.761,0,0,0-185.951,278.47Z" transform="translate(222.013 -253.83)" stroke="#00205c" stroke-width="1" />
