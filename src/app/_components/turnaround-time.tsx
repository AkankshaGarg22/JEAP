                ...
                {({ isMobile, isTablet }) => {
                    return <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center relative">
                        ...
                        <div className="relative z-10 h-full w-full flex justify-center items-center">
                            {!isMobile && !isTablet ? <>
                                <div className="absolute w-[950px] h-[350px] bottom-0">
                                    <div className="relative">
                                        <MyLottieComponent height={350} width={isMobile ? 300 : 950} animationSource={(animationlottie_1)} />
                                    </div>
                                </div>
                                <div className="absolute w-[950px] h-[450px] left-[250px]">
                                    <div className="relative">
                                        <MyLottieComponent height={isMobile ? 300 : 450} width={isMobile ? 200 : 950} animationSource={(animationlottie_2)} />
                                    </div>
                                </div>
                                <div className="absolute w-[950px] h-[450px] right-[250px]">
                                    <div className="relative">
