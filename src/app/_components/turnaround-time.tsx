    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center relative">
            ...
            {/* <div className="relative w-full h-full">
                {ImageSlice(, 0)}
                {ImageSlice("/assets/blog/24 to 48[1]-02.svg", 120)}
                {ImageSlice("/assets/blog/24 to 48[1]-01.svg", 240)}
            </div> */}
            <div className="absolute w-[300px] h-[300px] bg-white z-20 rounded-full">
                <VisibilitySensor>
                    {(isVisible: any) => {
