...
export function OutbreakDesktop(isVisible) {
  const isXlScreen = useMediaQuery("only screen and (min-width: 768px)"); // adjust the breakpoint as needed
...
export default OutbreakDesktop;
