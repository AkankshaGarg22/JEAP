    ...
    <Device>
      {({isMobile}) => {
        return <div ref={ref} id="operation" className="min-h-screen flex flex-col justify-evenly items-center py-[50px] md:py-[150px] font-CompasseRegular">
          <h1 className="text-[#000000] text-4xl md:text-7xl py-4 my-4 text-center tracking-tighter md:tracking-normal font-[compasse-extrabold]">OPERATIONALIZING THE JEAP</h1>
