...
const Menu: MenuItem[] = [
  {
    ...
    slides: ["/assets/blog/jpgs/JEAP_VISION_Slides-01.jpg"],
  ...
  },
  {
    ...
    slides: ["/assets/blog/jpgs/JEAP_VISION_Slides-02.jpg"],
  ...
  },
  {
    ...
    slides: ["/assets/blog/jpgs/JEAP_VISION_Slides-03.jpg"],
  ...
  },
  {
    ...
    slides: ["/assets/blog/jpgs/JEAP_VISION_Slides-04.jpg"],
  ...
  },
  {
    ...
    slides: ["/assets/blog/jpgs/JEAP_VISION_Slides-05.jpg"],
  ...
  },
  {
    ...
    slides: ["/assets/blog/jpgs/JEAP_VISION_Slides-06.jpg"],
  ...
  return (
    <div id="vision" className="min-h-screen flex flex-col items-center justify-evenly md:pt-[150px]">
      <div className="text-center md:p-3">
        <h2 className="text-[#000] text-7xl font-[compasse-extrabold] my-4">THE JEAP VISION</h2>
