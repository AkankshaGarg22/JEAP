  ...
  return (
    <Device>
      {({isMobile}) => {
        ...
        <h1 className="font-[compasse-extrabold] text-2xl md:text-4xl tracking-wide text-center pt-[35px] md:pt-[150px] px-8">INFECTIOUS DISEASE VULNERABILITY INDEX WORLD MAP</h1>
        <div className="h-[80svh] lg:h-[180svh] relative" >
          {data.length > 0 && (
