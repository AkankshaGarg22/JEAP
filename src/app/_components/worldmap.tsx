  ...
  return (
    <Device>
      {({isMobile}) => {
        ...
        <div className="h-[40svh] md:h-[65svh] xl:h-[180svh] relative" >
          {data.length > 0 && (
        ...
        <div className="w-full md:w-4/5 text-center bottom-[0svh] md:absolute md:bottom-[0svh] xl:absolute xl:bottom-[20svh]">
